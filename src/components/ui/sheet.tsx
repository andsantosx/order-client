...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-2xl transition ease-in-out data-[state=closed]:duration-500 data-[state=open]:duration-1000 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      {...props}
    >
      {/* Custom Header in ShopPage handles closing */}
      {children}
    </SheetPrimitive.Content>
  </SheetPortal>
))
