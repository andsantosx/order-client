    ...
    <section className="py-24 bg-background">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.2em] text-muted-foreground mb-2">Selected for You</p>
            <h2 className="font-[var(--font-display)] text-4xl md:text-5xl font-black uppercase tracking-tighter text-foreground">
              Weekly Highlights
            </h2>
          </div>
          <Button variant="link" className="hidden md:flex text-sm font-bold uppercase tracking-widest group px-0">
            View All Products
          ...
          {products.map((product) => (
            <div key={product.id} className="group cursor-pointer">
              ...
              <div className="relative aspect-[3/4] mb-5 overflow-hidden bg-secondary">
                {/* Badges could go here (e.g. New, Sale) */}
