...
const categories = [
  {
    id: 1,
    name: "Streetwear",
    description: "Estilo urbano contemporaneo",
  ...
  },
  {
    id: 2,
    name: "Minimal",
    description: "Elegancia em simplicidade",
  ...
  },
  {
    id: 3,
    name: "Sport Luxe",
    description: "Performance encontra estilo",
          ...
          {categories.map((category, index) => (
            ...
            >
              ...
              <div className={`absolute inset-0 rounded-3xl border-2 transition-all duration-500 ${
                hoveredId === category.id ? "border-primary/50" : "border-transparent"
              }`} />
            </div>
          ))}
        </div>
